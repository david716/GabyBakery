...
@section('content')
  <div class="row justify-content-end">
    <div class="col">
      <a href="{{ route('permission.create') }}" class="btn btn-default btn-flat btn-outline-success">
        ...
        <tr>
            ...
            <td>
                <div class="d-flex flex-row bd-highlight">
                    <a  href="{{ route('permission.edit', $item->id) }}"  class="btn btn btn-default btn-flat btn-outline-success">
