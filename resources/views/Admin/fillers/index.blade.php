...
@section('content')
  <div class="row justify-content-end">
    <div class="col">
      <a  href="{{ route('fillers.create') }}" class="btn btn-default btn-flat btn-outline-success">
        ...
        <tr>
            ...
            <td>
                <div class="d-flex flex-row bd-highlight">
                    <a  href="{{ route('fillers.edit', $item->id) }}" class="btn btn btn-default btn-flat btn-outline-success">
                  ...
                  @if(is_null($item->filler_id) and is_null($item->filler_1_id) and is_null($item->filler_2_id))
                    <form action="{{ route('fillers.destroy', $item->id) }}" method="post">
                        @csrf
                        @method('DELETE')
