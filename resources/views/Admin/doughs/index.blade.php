...
@section('content')
  <div class="row justify-content-end">
    <div class="col">
      <a href="{{ route('doughs.create') }}" class="btn btn-default btn-flat btn-outline-success">
        ...
        <tr>
            ...
            <td>
                <div class="d-flex flex-row bd-highlight">
                    <a  href="{{ route('doughs.edit', $item->id) }}"  class="btn btn btn-default btn-flat btn-outline-success">
                  ...
                  @if(is_null($item->dough_id) and is_null($item->dough_1_2_id) and is_null($item->dough_3_4_id))
                    <form action="{{ route('doughs.destroy', $item->id) }}" method="post">
                        @csrf
                        @method('DELETE')
