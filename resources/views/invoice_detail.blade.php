...
<div class="container">
    ...
    <div class="card">
        <div class="card-header text-center"> <h4>Informacion de Factura</h4> </div>
        <div class="card-body">
            <div class="row">
                <div class="col">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header text-center"> <h4>Imagen del Producto</h4> </div>
                <div class="card-body" style="padding: 0;">
                    <img src="{{ asset($item->images) }}" width="100%" height="290.09px">
                </div>
            </div>
        </div>
        @endif
        <div class="col">
            <div class="card">
                <div class="card-header text-center"> <h4>Informacion del Producto</h4> </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col">
    ...
    <div class="row">
        <div class="col">
            <a  href="{{ route('invoice', auth()->user()->id) }}" type="button" class="btn btn-success btn-block"> Volver </a>        </div>
        </div>
    </div>
    <br>
    @endforeach
