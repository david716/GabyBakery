              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="admin-lte/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="#" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Usuarios</span></a></li>
        <li><a href="{{ route('category.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Categorias</span></a></li>
        <li><a href="{{ route('products.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Productos</span></a></li>
        <li><a href="{{ route('decorations.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Decoraciones</span></a></li>
        <li><a href="{{ route('doughs.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Masas</span></a></li>
        <li><a href="{{ route('fillers.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Rellenos</span></a></li>
        <li><a href="{{ route('cake_coverage.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Cubiertas</span></a></li>
        <li><a href="{{ route('invoices.index') }}" class="d-block p-3 text-light"><i class="fa fa-pie-chart"></i><span>Facturas</span></a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
